...
class studentClass(models.Model):
    ...
    def __str__(self):
        return "[ %s / %s ] - %s %s %s" %(self.departementId.name,self.departementId.unit_id.name,self.subjectOfferId.subject_id.name,self.subjectOfferId.classRoomId.class_name,self.studentId.full_name)