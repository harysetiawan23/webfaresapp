 ...
 *   https://datatables.net/download/#bs4-4.1.1/jqc-1.12.4/dt-1.10.18/b-1.5.4/b-print-1.5.4/cr-1.5.0/kt-2.5.0/r-2.2.2/sc-1.5.0/sl-1.2.6
 *
 * Included libraries:
 *   Bootstrap 4 4.1.1, jQuery 1 1.12.4, DataTables 1.10.18, Buttons 1.5.4, Print view 1.5.4, ColReorder 1.5.0, KeyTable 2.5.0, Responsive 2.2.2, Scroller 1.5.0, Select 1.2.6
 */
...
(function (h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4-4.1.1/jqc-1.12.4/dt-1.10.18/b-1.5.4/b-print-1.5.4/cr-1.5.0/kt-2.5.0/r-2.2.2/sc-1.5.0/sl-1.2.6",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (e) {
    ...
    e.extend(i.prototype, {
        ...
        fnOrder: function (a, b) {
            var c = [], f, g, d = this.s.dt.aoColumns;
            if (a === r) {
                f = 0;
        ...
        _fnConstruct: function () {
            ...
            var c = this, f = e(a.target).closest("th, td").offset(), g = parseInt(e(b).attr("data-column-index"), 10);
            ...
            for (var b = !1, c = this.s.mouse.toIndex, f = 1, e = this.s.aoTargets.length; f < e; f++) if (this._fnCursorPosition(a, "pageX") < this.s.aoTargets[f - 1].x + (this.s.aoTargets[f].x - this.s.aoTargets[f - 1].x) / 2) {
            ...
            var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY,
                b = this.s.dt.aoColumns[this.s.mouse.targetIndex].nTh, c = b.parentNode,
                f = c.parentNode, g = f.parentNode, d = e(b).clone();
    ...
    e(l).on("preInit.dt.colReorder", function (a,
                                               b) {
        if ("dt" === a.namespace) {
            var c = b.oInit.colReorder, f = t.defaults.colReorder;
    ...
    e.extend(g.prototype, {
        fnRowToPixels: function (a, b, c) {
            ...
            if (this.s.dt.oFeatures.bPaginate) {
                ...
                this.s.heights.row && "auto" != this.s.heights.row && (this.s.autoHeight =
                    !1);
                this.fnMeasure(!1);
            ...
            var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop, d = e(this.s.dt.nTable).height(),
                f = this.s.dt._iDisplayStart, j = this.s.dt._iDisplayLength, g = this.s.dt.fnRecordsDisplay();
            this.s.skip = !0;
            ...
            if (this.s.dt.oFeatures.bInfo) {
                var a = this.s.dt, b = a.oLanguage, c =
                    ...
                    c = Math.ceil(this.fnPixelsToRow(c + this.s.heights.viewport, !1, this.s.ani)), c = g < c ? g : c,
                    h = a.fnFormatNumber(d), i = a.fnFormatNumber(c), k = a.fnFormatNumber(f), l = a.fnFormatNumber(g),
...
(function (e) {
    ...
    function x(a) {
        ...
        c.on("mousedown.dtSelect", d, function (b) {
            ...
            var d = a.settings()[0], g = a.settings()[0].oClasses.sWrapper.replace(/ /g, ".");
    ...
    g.select.init = function (a) {
        var c = a.settings()[0], b = c.oInit.select, d = g.defaults.select, b = b === h ? d : b, d = "row", f = "api",
            k = !1, v = !0, w = "td, th", i = "selected", j = !1;
        c._select = {};
        if (!0 === b) f = "os", j = !0; else if ("string" === typeof b) f = b, j = !0; else if (e.isPlainObject(b) && (b.blurable !== h && (k = b.blurable), b.info !== h && (v = b.info), b.items !== h && (d = b.items), b.style !== h &&
